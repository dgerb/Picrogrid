...
# 2. Place one Reset jumper on the MicroPanelH at location 26
...
# MicroPanel: jumper 26
sudo avrdude -c linuxgpio26 -p atmega328p -v -U flash:w:/home/$USER/Picrogrid/PicroBoards/MicroPanelHExamples/BasicExamples/3_SmartPanel/build/arduino.avr.uno/3_SmartPanel.ino.with_bootloader.hex:i
sleep 2
