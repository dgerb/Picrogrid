/*
  ...
  Works with the Arduino Serial Console (requires FTDI USB/TTL cable to a computer), Pi_UART_Shell.py
  (requires FTDI USB/TTL cable to a Raspberry Pi), and Pi_I2C_Shell.py (requires direct pin conection to
  a Raspberry Pi).
